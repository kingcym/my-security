package com.cym.security.browser.filter.validate;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public ValidateCodeFilter() {
        requiresAuthenticationRequestMatcher =new AntPathRequestMatcher("/authentication/form", "POST");
    }
    //操作session
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        if (browserProperties.getImageUrl() != null){
            String[] configUrls = StringUtils.splitByWholeSeparatorPreserveAllTokens(browserProperties.getImageUrl(), ",");
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        logger.info("===========进入ValidateCodeFilter过滤器=====================");
